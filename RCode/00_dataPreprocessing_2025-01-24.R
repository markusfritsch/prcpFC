...
stat2.2 <- cbind(stat2[,c(1:8)], statK2[,2], stat2$statID %in% colnames(dat_demeded))
names(stat2.2)	<- c("statID", "lat", "lon", "alt", "statName", "stateUS", "network", "aa", "koppen2", "is.in.data")
...
load(file = "rainresults_all_shortmed_2025-01-16.RData")
